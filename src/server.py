...
RESPONSE_FIELDS: Dict[str, Dict[str, Optional[List[str]]]] = {
    "project": {
        ...
        "standard": ["id", "name", "slug", "description", "is_private", "tags",
                     "created_date", "modified_date", "version"],
        "full": None
    },
    "user_story": {
        "minimal": ["id", "ref", "subject", "status", "project"],
        "standard": ["id", "ref", "subject", "description", "status", "status_extra_info",
                     "assigned_to", "assigned_to_extra_info", "milestone", "project",
                     "tags", "is_blocked", "is_closed", "due_date", "version"],
        "full": None
    },
    "task": {
        "minimal": ["id", "ref", "subject", "status", "project"],
        "standard": ["id", "ref", "subject", "description", "status", "status_extra_info",
                     "assigned_to", "assigned_to_extra_info", "user_story", "milestone",
                     "project", "tags", "is_blocked", "due_date", "version"],
        "full": None
    },
    "issue": {
        "minimal": ["id", "ref", "subject", "status", "priority", "severity", "project"],
        "standard": ["id", "ref", "subject", "description", "status", "status_extra_info",
                     "priority", "priority_extra_info", "severity", "severity_extra_info",
                     "type", "type_extra_info", "assigned_to", "assigned_to_extra_info",
                     "milestone", "project", "tags", "is_blocked", "due_date", "version"],
        "full": None
    },
    "epic": {
        "minimal": ["id", "ref", "subject", "status", "project"],
        "standard": ["id", "ref", "subject", "description", "status", "status_extra_info",
                     "assigned_to", "assigned_to_extra_info", "project", "tags",
                     "color", "version"],
        "full": None
    },
    "milestone": {
        "minimal": ["id", "name", "slug", "project"],
        "standard": ["id", "name", "slug", "estimated_start", "estimated_finish",
                     "closed", "project", "version"],
        "full": None
    },
    "member": {
        "minimal": ["id", "user", "full_name"],
        "standard": ["id", "user", "full_name", "email", "role", "role_name",
                     "is_admin", "project"],
        "full": None
    },
    "wiki_page": {
...
@mcp.tool("list_projects", description="Lists projects accessible to the authenticated user. verbosity: 'minimal' (id/name/slug), 'standard' (default), 'full'. Uses default session if session_id not provided.")
def list_projects(session_id: Optional[str] = None, verbosity: str = "standard") -> List[Dict[str, Any]]:
...
@mcp.tool("list_all_projects", description="Lists all projects visible to the user (requires admin privileges for full list). verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def list_all_projects(session_id: Optional[str] = None, verbosity: str = "standard") -> List[Dict[str, Any]]:
...
@mcp.tool("get_project", description="Gets detailed information about a specific project by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def get_project(project_id: int, session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("get_project_by_slug", description="Gets detailed information about a specific project by its slug. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def get_project_by_slug(slug: str, session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("create_project", description="Creates a new project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def create_project(name: str, description: str, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
    ...
    result = _execute_taiga_operation(
        "create_project",
        lambda: taiga_client_wrapper.api.projects.create(name=name, description=description, **parsed_kwargs),
        f"project '{name}'"
    )
    return _filter_response(result, "project", verbosity)


@mcp.tool("update_project", description="Updates details of an existing project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def update_project(project_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("list_user_stories", description="Lists user stories within a specific project, optionally filtered. verbosity: 'minimal' (id/ref/subject/status/project), 'standard' (default), 'full'. Uses default session if session_id not provided.")
def list_user_stories(project_id: int, filters: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> List[Dict[str, Any]]:
...
@mcp.tool("create_user_story", description="Creates a new user story within a project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def create_user_story(project_id: int, subject: str, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
    ...
    result = _execute_taiga_operation(
        "create_user_story",
        lambda: taiga_client_wrapper.api.user_stories.create(project=project_id, subject=subject, **parsed_kwargs),
        f"user story '{subject}'"
    )
    return _filter_response(result, "user_story", verbosity)


@mcp.tool("get_user_story", description="Gets detailed information about a specific user story by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def get_user_story(user_story_id: int, session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("update_user_story", description="Updates details of an existing user story. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def update_user_story(user_story_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("list_tasks", description="Lists tasks within a specific project, optionally filtered. verbosity: 'minimal' (id/ref/subject/status/project), 'standard' (default), 'full'. Uses default session if session_id not provided.")
def list_tasks(project_id: int, filters: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> List[Dict[str, Any]]:
...
@mcp.tool("create_task", description="Creates a new task within a project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def create_task(project_id: int, subject: str, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
    ...
    result = _execute_taiga_operation(
        "create_task",
        lambda: taiga_client_wrapper.api.tasks.create(project=project_id, subject=subject, data=parsed_kwargs if parsed_kwargs else None),
        f"task '{subject}'"
    )
    return _filter_response(result, "task", verbosity)


@mcp.tool("get_task", description="Gets detailed information about a specific task by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def get_task(task_id: int, session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("update_task", description="Updates details of an existing task. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def update_task(task_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("list_issues", description="Lists issues within a specific project, optionally filtered. verbosity: 'minimal' (id/ref/subject/status/priority/severity/project), 'standard' (default), 'full'. Uses default session if session_id not provided.")
def list_issues(project_id: int, filters: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> List[Dict[str, Any]]:
...
@mcp.tool("create_issue", description="Creates a new issue within a project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def create_issue(project_id: int, subject: str, priority_id: int, status_id: int, severity_id: int, type_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("get_issue", description="Gets detailed information about a specific issue by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("update_issue", description="Updates details of an existing issue. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def update_issue(issue_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("list_epics", description="Lists epics within a specific project, optionally filtered. verbosity: 'minimal' (id/ref/subject/status/project), 'standard' (default), 'full'. Uses default session if session_id not provided.")
def list_epics(project_id: int, filters: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> List[Dict[str, Any]]:
...
@mcp.tool("create_epic", description="Creates a new epic within a project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def create_epic(project_id: int, subject: str, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
    ...
    result = _execute_taiga_operation(
        "create_epic",
        lambda: taiga_client_wrapper.api.epics.create(project=project_id, subject=subject, **parsed_kwargs),
        f"epic '{subject}'"
    )
    return _filter_response(result, "epic", verbosity)


@mcp.tool("get_epic", description="Gets detailed information about a specific epic by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("update_epic", description="Updates details of an existing epic. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def update_epic(epic_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("list_milestones", description="Lists milestones (sprints) within a specific project. verbosity: 'minimal' (id/name/slug/project), 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("create_milestone", description="Creates a new milestone (sprint) within a project. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("get_milestone", description="Gets detailed information about a specific milestone by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("update_milestone", description="Updates details of an existing milestone. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
def update_milestone(milestone_id: int, kwargs: str = "{}", session_id: Optional[str] = None, verbosity: str = "standard") -> Dict[str, Any]:
...
@mcp.tool("get_project_members", description="Lists members of a specific project. verbosity: 'minimal' (id/user/full_name), 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("list_wiki_pages", description="Lists wiki pages within a specific project. verbosity: 'minimal' (id/slug/project), 'standard' (default), 'full'. Uses default session if session_id not provided.")
...
@mcp.tool("get_wiki_page", description="Gets a specific wiki page by its ID. verbosity: 'minimal', 'standard' (default), 'full'. Uses default session if session_id not provided.")
